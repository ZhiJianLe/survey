...
<div class="radioTemplate" style="display: none">
    <li class="using radio">
        ...
        <div class="required">
            ...
            <span class="edit hide answer" title="答案序号" contenteditable="true" style="width: 60px;padding: 7px 20px;">1</span>
        </div>
        <div class="options">
    ...
    layui.use(['jquery','layer'],function () {
        ...
        function save(obj){
            ...
            obj.find('.required').find('div').each(function(index){
                if(index == 0){ //layui-form-checked表示是否勾选，整个判断表示，第一个（是否为必填项）是否勾选
